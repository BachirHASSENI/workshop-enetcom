...
class HomeViewController: UIViewController {
    ...
    var placesList : [ PlaceModel] = [ PlaceModel(title: "Bizerte", image : "imageBizerte", distance: "400", categorie: "tourisme"),
                                       PlaceModel(title: "Tunis", image : "imageTunis", distance: "300", categorie: "tourisme"),
                                       PlaceModel(title: "Touzeur", image : "imageTozeur", distance: "200", categorie: "tourisme"),
                                       PlaceModel(title: "Sousse", image : "imageSousse", distance: "150", categorie: "tourisme")]
